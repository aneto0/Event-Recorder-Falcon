...
static bool CheckPacket(const MARTe::char8 * const config, CRIOFPSPacket *packets, MARTe::uint32 numberOfPackets) {
    ...
    for (k = 0; k < numberOfPackets; k++) {
        ...
        if (ok) {
            ...
            uint32 n;
            //Do not crc, packet counter, synch byte, trigger and validation
            uint32 signalsToCheck = gam->GetNumberOfOutputSignals() - 5u;
...
bool PacketGAMTest::TestExecute() {
    ...
    uint8 packetTestDefinition[numberOfPackets][15] = {
            { 0x0D, 0x48, 0x55, 0x00, 0x80, 0x1C, 0x00, 0xF8, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
            { 0x02, 0x64, 0xAA, 0x01, 0x80, 0x1C, 0xF0, 0xFF, 0x03, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 },
            { 0x87, 0x76, 0x55, 0x02, 0x80, 0x18, 0xF0, 0xFF, 0x03, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00 },
            { 0x35, 0x46, 0xAA, 0x03, 0x60, 0x1C, 0xF0, 0xFF, 0x03, 0x00, 0x01, 0x00, 0x00, 0x01, 0x00 },
            { 0x92, 0xE0, 0x55, 0x00, 0x60, 0x1C, 0xF0, 0xFF, 0x43, 0x00, 0x5C, 0x8D, 0xCA, 0x12, 0x00 }, { 0x6B, 0x94, 0xAA, 0x01, 0x60, 0x1C, 0xF0, 0xFF,
...
bool PacketGAMTest::TestExecute_CRC() {
    ...
    uint8 packetTestDefinition[numberOfPackets][15] = {
            { 0x0D, 0x48, 0x55, 0x00, 0x80, 0x1C, 0x00, 0xF8, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
            { 0x02, 0x64, 0xAA, 0x02, 0x80, 0x1C, 0xF0, 0xFF, 0x03, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 },
            { 0x87, 0x76, 0x55, 0x02, 0x80, 0x18, 0xF0, 0xFF, 0x03, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00 } };
...
bool PacketGAMTest::TestExecute_CRC_Synchronism() {
    ...
    uint8 packetTestDefinition[numberOfPackets][15] = {
            { 0x0D, 0x48, 0x55, 0x00, 0x80, 0x1C, 0x00, 0xF8, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
            { 0x02, 0x64, 0x55, 0x02, 0x80, 0x1C, 0xF0, 0xFF, 0x03, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 },
            { 0x87, 0x76, 0x55, 0x02, 0x80, 0x18, 0xF0, 0xFF, 0x03, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00 } };
...
bool PacketGAMTest::TestExecute_Packet_Counter() {
    ...
    uint8 packetTestDefinition[numberOfPackets][15] = {
            { 0x0D, 0x48, 0x55, 0x00, 0x80, 0x1C, 0x00, 0xF8, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
            { 0x35, 0x46, 0xAA, 0x03, 0x60, 0x1C, 0xF0, 0xFF, 0x03, 0x00, 0x01, 0x00, 0x00, 0x01, 0x00 },
            { 0x92, 0xE0, 0x55, 0x00, 0x60, 0x1C, 0xF0, 0xFF, 0x43, 0x00, 0x5C, 0x8D, 0xCA, 0x12, 0x00 }
    };
