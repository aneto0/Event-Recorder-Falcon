...
static bool CheckPacket(const MARTe::char8 * const config, CRIOFPSPacket *packets, MARTe::uint32 numberOfPackets) {
    ...
    for (k = 0; k < numberOfPackets; k++) {
        if (ok) {
            ...
            *gamInputMemory = 1u;
            //The packet is @ idx 1
            packets[k].Copy(&gamInputMemory[1u]);
...
static bool CheckPacketWithError(const MARTe::char8 * const config, CRIOFPSPacket *packet, MARTe::uint32 numberOfPackets, MARTe::uint8 *expectedTrigger, MARTe::uint8 *expectedErrorCode) {
    ...
    for (k = 0; (k < numberOfPackets) && (ok); k++) {
        if (ok) {
            ...
            *gamInputMemory = 1u;
            //The packet is @ idx 1
            packet[k].Copy(&gamInputMemory[1u]);
        }
        if (ok) {
            ok = gam->Execute();
        }
...
bool PacketGAMTest::TestSetup() {
    return TestIntegratedInApplication(config1, true);
}

bool PacketGAMTest::TestSetup_Not2Inputs() {
...
bool PacketGAMTest::TestSetup_BadSignal0() {
    const MARTe::char8 * const config = ""
            "$Test = {"
            "    Class = RealTimeApplication"
            "    +Functions = {"
...
bool PacketGAMTest::TestSetup_BadSignal1() {
    const MARTe::char8 * const config = ""
            "$Test = {"
            "    Class = RealTimeApplication"
            "    +Functions = {"
...
bool PacketGAMTest::TestSetup_Not54Outputs() {
    const MARTe::char8 * const config = ""
            "$Test = {"
            "    Class = RealTimeApplication"
            "    +Functions = {"
...
bool PacketGAMTest::TestSetup_BadTimeSignal() {
    const MARTe::char8 * const config = ""
            "$Test = {"
            "    Class = RealTimeApplication"
            "    +Functions = {"
...
bool PacketGAMTest::TestSetup_BadLastSignal() {
    const MARTe::char8 * const config = ""
            "$Test = {"
            "    Class = RealTimeApplication"
            "    +Functions = {"
...
bool PacketGAMTest::TestSetup_BadCRCSignal() {
    const MARTe::char8 * const config = ""
            "$Test = {"
            "    Class = RealTimeApplication"
            "    +Functions = {"
...
bool PacketGAMTest::TestSetup_BadBitSignal() {
    const MARTe::char8 * const config = ""
            "$Test = {"
            "    Class = RealTimeApplication"
            "    +Functions = {"
...
bool PacketGAMTest::TestSetup_BadDimensions() {
    const MARTe::char8 * const config = ""
            "$Test = {"
            "    Class = RealTimeApplication"
            "    +Functions = {"
...
bool PacketGAMTest::TestExecute_FirstTime_NotZero() {
    ...
    uint8 packetTestDefinition[numberOfPackets][15] = { { 0x54, 0xC9, 0x55, 0x02, 0xDD, 0x03, 0xF0, 0xFF, 0x43, 0xC0, 0x34, 0xCD, 0x7F, 0x0A, 0x00 }, { 0xE2, 0x8C, 0xAA, 0x03, 0x3D, 0x03, 0xF0, 0xFF,
...
bool PacketGAMTest::TestPrepareNextState() {
    bool ok = true;
    const uint32 numberOfPackets = 2;
    uint8 packetTestDefinition[numberOfPackets][15] = { { 0x0D, 0x48, 0x55, 0x00, 0x80, 0x1C, 0x00, 0xF8, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
            { 0x02, 0x64, 0xAA, 0x01, 0x80, 0x1C, 0xF0, 0xFF, 0x03, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 } };
